class OrderHistoryRequestBody {
  ...
  OrderHistoryRequestBody({this.pageIndex, this.pageCount,this.units,this.userId,this.dateForm,this.dateTo,this.dataType});

  OrderHistoryRequestBody.fromJson(Map<String?, dynamic> json) {
