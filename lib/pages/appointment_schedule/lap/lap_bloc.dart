...
//
// import 'lap_event.dart';
// import 'lap_sate.dart';
//
// class LapBloc extends Bloc<LapEvent,LapState>{
//
//
...
//   LapState get initialState => CustomerInitial();
//
//   @override
//   Stream<LapState> mapEventToState(LapEvent event) async* {
...
//           LapState state = await handleCallApi(i,event.dateFrom,event.dateTo);
...
//   }
//
//   Future<LapState> handleCallApi(int pageIndex,String dateForm, String dateTo) async {
...
//         dateForm: dateForm,
//         dateTo: dateTo,
//         status: '7,8',units: unitId
//
//     );
//
//     LapState state = _handleLoadList(
//         await _networkFactory.getListAppointmentSchedule(request,_accessToken), pageIndex);
//     return state;
//   }
//   LapState _handleLoadList(Object data, int pageIndex) {
