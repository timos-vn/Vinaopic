...
class LapPage extends StatefulWidget {
  @override
  _LapPagePageState createState() => _LapPagePageState();
}

class _LapPagePageState extends State<LapPage> {
  ...
  void initState() {
    ...
    _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2), status: '7,8'));
    ...
    _scrollController.addListener(() {
      ...
      if (maxScroll - currentScroll <= _scrollThreshold && !_hasReachedMax && _bloc.isScroll == true) {
        _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),isLoadMore: true, status: '7,8'));
      }
    });
  }
