...
class _FixPagePageState extends State<FixPage> {
  ...
  void initState() {
    ...
    _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),status: '5'));
    ...
    _scrollController.addListener(() {
      ...
      if (maxScroll - currentScroll <= _scrollThreshold && !_hasReachedMax && _bloc.isScroll == true) {
        _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),isLoadMore: true,status: '5'));
      }
    });
  }
