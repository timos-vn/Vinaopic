...
class ChoKhamPage extends StatefulWidget {
  @override
  _ChoKhamPageState createState() => _ChoKhamPageState();
}

class _ChoKhamPageState extends State<ChoKhamPage> {
  ...
  void initState() {
    ...
    _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2), status: '1'));
    ...
    _scrollController.addListener(() {
      ...
      if (maxScroll - currentScroll <= _scrollThreshold && !_hasReachedMax && _bloc.isScroll == true) {
        _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),isLoadMore: true, status: '1'));
      }
    });
  }
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            // SizedBox(height: 15,),
                            Expanded(
                              child:Utils.isEmpty(_list) ? Center(child: Image.asset(noData,fit: BoxFit.contain,))
                                  :
                              Padding(
