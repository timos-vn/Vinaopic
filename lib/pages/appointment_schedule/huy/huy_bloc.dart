...
//
// import 'huy_event.dart';
// import 'huy_sate.dart';
//
//
//
// class HuyBloc extends Bloc<HuyEvent,HuyState>{
//
//
...
//   HuyState get initialState => CustomerInitial();
//
//   @override
//   Stream<HuyState> mapEventToState(HuyEvent event) async* {
...
//           HuyState state = await handleCallApi(i,event.dateFrom,event.dateTo);
...
//   }
//
//   Future<HuyState> handleCallApi(int pageIndex,String dateForm, String dateTo) async {
...
//         dateForm: dateForm,
//         dateTo: dateTo,
//         status: '3',units: unitId
//
//     );
//
//     HuyState state = _handleLoadList(
//         await _networkFactory.getListAppointmentSchedule(request,_accessToken), pageIndex);
//     return state;
//   }
//   HuyState _handleLoadList(Object data, int pageIndex) {
