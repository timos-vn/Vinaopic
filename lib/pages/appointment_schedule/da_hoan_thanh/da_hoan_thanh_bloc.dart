...
//
// import 'da_hoan_thanh_event.dart';
// import 'da_hoan_thanh_sate.dart';
//
// class DaHoanThanhBloc extends Bloc<DaHoanThanhEvent,DaHoanThanhState>{
//
...
//   DaHoanThanhState get initialState => CustomerInitial();
//
//   @override
//   Stream<DaHoanThanhState> mapEventToState(DaHoanThanhEvent event) async* {
//     if (_prefs == null) {
...
//           DaHoanThanhState state = await handleCallApi(i,event.dateFrom,event.dateTo);
...
//
//   }
//   Future<DaHoanThanhState> handleCallApi(int pageIndex,String dateForm, String dateTo) async {
...
//         dateForm: dateForm,
//         dateTo: dateTo,
//         status: '2',units: unitId
//
//     );
//
//     DaHoanThanhState state = _handleLoadList(
//         await _networkFactory.getListAppointmentSchedule(request,_accessToken), pageIndex);
//     return state;
//   }
//   DaHoanThanhState _handleLoadList(Object data, int pageIndex) {
