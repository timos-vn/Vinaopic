...
class DaHoanThanhPage extends StatefulWidget {
  @override
  _DaHoanThanhPageState createState() => _DaHoanThanhPageState();
}

class _DaHoanThanhPageState extends State<DaHoanThanhPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2), status: '2'));
    ...
    _scrollController.addListener(() {
      ...
      if (maxScroll - currentScroll <= _scrollThreshold && !_hasReachedMax && _bloc.isScroll == true) {
        _bloc.add(GetList(Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),Utils.parseDateToString(DateTime.now(), Const.DATE_SV_FORMAT_2),isLoadMore: true, status: '2'));
      }
    });
  }
