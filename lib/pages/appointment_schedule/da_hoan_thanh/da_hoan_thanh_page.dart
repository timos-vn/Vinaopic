...
class _DaHoanThanhPageState extends State<DaHoanThanhPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _bloc.add(GetList(Jiffy(DateTime.now(), "dd-MM-yyyy").format("yyyy-MM-dd"),Jiffy(DateTime.now(), "dd-MM-yyyy").format("yyyy-MM-dd"), status: '2'));
    ...
    _scrollController.addListener(() {
      ...
      if (maxScroll - currentScroll <= _scrollThreshold && !_hasReachedMax && _bloc.isScroll == true) {
        _bloc.add(GetList(Jiffy(DateTime.now(), "dd-MM-yyyy").format("yyyy-MM-dd"),Jiffy(DateTime.now(), "dd-MM-yyyy").format("yyyy-MM-dd"),isLoadMore: true, status: '2'));
      }
    });
  }
